<div id="rankingsemanal_container">
			...
			<div id="tipo_visualizacion" class="">
				...
				<div class="rank_cont">
					<div class="titulo_cont">
						<div class="titulo">
							<div class="texto">RANKING SEMANAL DE JUGADORES</div>
							<div class="sub_texto">SEMANA DEL <?php echo $inicio_semana; ?> AL <?php echo $fin_semana; ?></div>
						</div>
					</div>
