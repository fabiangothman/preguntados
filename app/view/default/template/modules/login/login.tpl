								...
								<div class="cont_campos">
									...
									<div class="campo datos">
										<div class="cont_texto">
											<div class="texto">Cédula o Correo:</div>
										</div>
										<div class="cont_input">
											<input class="input" type="text" name="email" placeholder="cc@homecenter.co" required="true" />
										</div>
									</div>
									<div class="campo datos">
										<div class="cont_texto">
									...
									<div class="campo mensajes">
										<div class="cont_mensajes">
											<div class="mensaje"><a href="<?php echo $ir_recuperar; ?>">¿Ha olvidado su contraseña de usuario?</a></div>
											<div class="mensaje"><a href="<?php echo $ir_admin; ?>">Iniciar sesión como administrador</a></div>
										</div>
									</div>
